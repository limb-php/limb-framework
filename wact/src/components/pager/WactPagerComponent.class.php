...
class WactPagerComponent extends WactRuntimeComponent
{
  ...
  function prepare()
  {
    if (!$this->total_items && $this->paged_dataset)
  ...
  function setBaseUrl($base_url = null)
  {
    $this->base_url = isset($base_url) ? $base_url : '';
  ...
  protected function _initBaseUrl()
  {
    ...
    if(!$this->base_url)
      $this->setBaseUrl($request->getUriPath());

    $this->displayed_page = $request->getInteger($this->getPagerId());
