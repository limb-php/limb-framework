...
class lmbMacroTreeTag extends lmbMacroTag
{
    protected function _generateContent($code_writer)
    {
        ...
        $tree_node = $this->findImmediateChildByClass('limb\macro\tags\tree\lmbMacroTreeNodeTag');
    ...
    {
        if ($list_empty = $this->findImmediateChildByClass('limb\\macro\\tags\\tree\\lmbMacroTreeEmptyTag')) {
