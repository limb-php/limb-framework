 ...
 * @version $Id: $
 */
class lmbGdSharpenImageFilter extends lmbAbstractImageFilter
{
    function apply(lmbAbstractImageContainer $container)
    {
        $img = $container->getResource();
    ...
    function getRadius()
    {
        return $this->getParam('radius', 1.0);
    }

    function getAmount()
    {
        return $this->getParam('amount', 80.0);
    }

    function getThreshold()
    {
        return $this->getParam('threshold', 3.0);
    }
}
