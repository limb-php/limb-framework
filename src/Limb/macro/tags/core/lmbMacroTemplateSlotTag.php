...
class lmbMacroTemplateSlotTag extends lmbMacroTag
{
    ...
    {
        $parent_template_tag = $this->findParentByClass('limb\macro\tags\core\lmbMacroTemplateTag'); # DO NOT CHANGE
        $apply_tag = $parent_template_tag->getCurrentApplyTag();

        $intos = $apply_tag->findChildrenByClass('limb\macro\tags\core\lmbMacroApplyIntoTag');
