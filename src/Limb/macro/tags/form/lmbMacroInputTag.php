...
class lmbMacroInputTag extends lmbMacroFormTagElement
{
    ...
    function preParse($compiler): void
    {
        ...
        switch ($type) {
            ...
            case 'image':
            case 'button':
                $this->widget_class_name = 'limb\macro\tags\form\lmbMacroInputWidget';
                break;
            case 'checkbox':
            case 'radio':
                $this->widget_class_name = 'limb\macro\tags\form\lmbMacroCheckableInputWidget';
                break;
            case 'password':
            case 'submit':
            case 'reset':
            case 'file':
                $this->widget_class_name = 'limb\macro\tags\form\lmbMacroFormElementWidget';
                break;
            default:
