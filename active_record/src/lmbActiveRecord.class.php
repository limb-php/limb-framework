...
class lmbActiveRecord extends lmbObject
{
  ...
  protected function _loadAggregatedObject($property, $value = null)
  {
    // for BC
  ...
  */
  ...
  protected function _importAggregatedObject($property, $value_or_obj)
  {
    if(is_object($value_or_obj))
      return $this->set($property, $value_or_obj);
